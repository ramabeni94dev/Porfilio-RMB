...
const ProfileCard = () => {
  return (
    <div className="text-white w-full flex flex-row items-center justify-around p-4 mt-40 mb-40">
      <div className="flex flex-col items-center space-y-4 pr-10">
        <h1 className="text-2xl font-bold text-center">Hi, I&rsquo;m Ramiro</h1>
        <p className="text-md text-center">Web Developer</p>
